...
This keeps `docs/design-log.md` principle 1 (proportional challenge) and
...
- `docs/design-log.md` (dated decision entry), `plans/README.md` (status row)
...
- [ ] `CLAUDE.md`, `docs/design-log.md`, and `plans/README.md` describe the new
      surfaces
