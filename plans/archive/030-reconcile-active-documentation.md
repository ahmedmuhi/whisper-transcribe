...
- `docs/design-log.md:25-28` makes `RECORDING_STATE_CHANGED` the single control
...
settings, archived `docs/archive/pre-2.0/**` documents, generated docs, or redesigning
the spec format.
