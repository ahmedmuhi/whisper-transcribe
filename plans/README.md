...
| 031 | [Adopt Vite/MSAL packaging and deploy the built static artifact through GitHub Actions](https://github.com/ahmedmuhi/whisper-transcribe/issues/114) | P1 | L | — | DONE (local `a2eb0d1`, `f64c957`; build, lint, coverage 32/405, Knip, high-audit, size, Chromium ×2, YAML and scope checks passed) |
