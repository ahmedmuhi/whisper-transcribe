...
| 031 | [Adopt Vite/MSAL packaging and deploy the built static artifact through GitHub Actions](https://github.com/ahmedmuhi/whisper-transcribe/issues/114) | P1 | L | — | DONE (local `a2eb0d1`, `f64c957`, `250075e`; build-before-live red/green, build, lint, 32/406, Knip, high-audit, size, Chromium ×2, YAML and scope checks passed) |
